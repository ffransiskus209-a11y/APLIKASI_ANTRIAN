...
4.	Sebagai Customer, saya ingin mengambil nomor antrean agar dapat mendapatkan giliran pelayanan.
...
4.	Sistem dapat menampilkan daftar layanan yang tersedia.
5.	Customer dapat memilih layanan yang diinginkan.
6.	Customer dapat mengambil nomor antrean setelah memilih layanan.
7.	Sistem dapat memberikan nomor antrean kepada Customer.
8.	Sistem dapat menampilkan status dan posisi antrean Customer.
9.	Sistem dapat mengirimkan notifikasi antrean kepada Customer.
10.	Customer dapat membatalkan nomor antrean.
11.	Admin dapat melihat seluruh antrean yang masuk.
...
5.	Sistem harus dapat digunakan ketika Customer maupun Admin membutuhkan layanan antrean.
6.	Sistem harus dapat menangani pertambahan jumlah Customer dan antrean tanpa mengalami penurunan kinerja yang signifikan.
7.	Sistem harus mudah diperbaiki, dikembangkan, dan diperbarui oleh pengembang.
8.	Aplikasi dapat digunakan pada perangkat dan lingkungan sistem yang ditentukan untuk QueueApp.
9.	Data nomor antrean dan status harus tersimpan secara konsisten dan akurat.
10.	Data penting sistem harus memiliki mekanisme pencadangan untuk mengurangi risiko kehilangan data.
